...
// 会員用セッション名
define("_USER_SESSNAME", "PHPSESSION_USER");

// 管理者用セッション名
//define("_SYSTEM_SESSNAME", "PHPSESSION_SYSTEM");

// 会員用認証情報 保管変数名
define("_USER_AUTHINFO", "userinfo");
...
require_once( _CLASS_DIR        . "UserController.php");
require_once( _CLASS_DIR        . "UserModel.php");
require_once( _CLASS_DIR        . "MessageController.php");
require_once( _CLASS_DIR        . "MessageModel.php");
